...
/*
Rank Part 1 : 432
Time Part 1 : 00 : 24 : 06

Rank Part 2 : 384
Time Part 2 : 00 : 24 : 22

Notes : As last year, this last problem is a bit of a throwaway/oddity. It's not worth the time reading the input, instead opting to just hardcode it all. 
...
void stateMove(int &currState, int &index, unordered_map<int, bool> &myMap);
...
void Challenge25() {
	...
	for (int64_t m = 0; m < 12134527; m++) {
		stateMove(state, index, myMap);
