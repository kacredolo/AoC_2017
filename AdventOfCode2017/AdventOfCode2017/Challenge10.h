...
Rank Part 1 : 255
Time Part 1 : 00 : 19 : 01

Rank Part 2 : 345
Time Part 2 : 00 : 45 : 46

Notes : Part 2 just kept going. Do this, now do this, then do this, and do this. This year's problems have been pretty chaotic as to the difficulty and the difference in part 1 and part 2.
I ranked decently on this one. I had to replace most of part 1 to do part 2.
...
void Challenge10() {
	ifstream input;
	input.open("Input/Challenge10/Input.txt");
	string line;
